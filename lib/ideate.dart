...
class _IdeateState extends State<Ideate> {
  ...
  Future<void> fetchData() async {
    try {
      List fetchedFrontCards = await getIdeate();
      List fetchedBackCards = await getBack2();
      setState(() {
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image:
                    AssetImage('assets/images/Design_Thinking_Ideate_Page.png'),
                fit: BoxFit.cover,
              ),
            ),
          ),
